...
public class DBDataFanXing {
    ...
    static {
        try {
            jdbcPros.load(DBDataFanXing.class.getResourceAsStream("/fanxing.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) throws SQLException {
        System.out.println(DBDataFanXing.findById(12, "osc_users"));
    }
}
