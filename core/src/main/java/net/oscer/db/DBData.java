...
public class DBData {
    ...
    static {
        try {
            jdbcPros.load(DBData.class.getResourceAsStream("/db.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static boolean updateById(String sql) throws SQLException {
        return runner().update(sql) > 0;
    }

    public static boolean updateById(String sql, Object... params) throws SQLException {
        return runner().update(sql, params) > 0;
    }

    public static void main(String[] args) throws SQLException {
        System.out.println(DBData.findById(12, "osc_users"));
    }
}
