...
public class HttpTools {
    ...
    public static Map<String, String> analysisParams(String path) {
        try {
    ...
    public static String postJson(String uri, Object body) throws IOException {
        HttpClient client = new HttpClient();
        PostMethod method = new PostMethod(uri);
        method.setRequestEntity(new StringRequestEntity(
                JSON.toJSONString(body), "application/json", "utf-8"));
        client.executeMethod(method);
        byte[] bytes = method.getResponseBody();
        return new String(bytes, method.getResponseCharSet());
    }
