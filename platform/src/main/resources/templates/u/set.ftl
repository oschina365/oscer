          ...
          <form method="post" action="/u/set_info">
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="text" id="L_email" name="email" required lay-verify="email" autocomplete="off" value="${login_user.email}" class="layui-input">
              </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-inline">
                <div class="layui-input-inline">
                  <input type="radio" name="sex" value="0" <#if login_user.sex==1>checked</#if> title="男">
                  <input type="radio" name="sex" value="1" <#if login_user.sex==2>checked</#if> title="女">
                </div>
              </div>
            </div>
            <div class="layui-form-item">
