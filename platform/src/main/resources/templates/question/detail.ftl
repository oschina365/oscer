    ...
    <div class="layui-col-md8 content detail">
      <div class="fly-panel detail-box">
        ...
        <div class="fly-detail-info">
          ...
          <#if q.top ==1><span class="layui-badge layui-bg-black">置顶</span></#if>
          ...
          <div class="fly-admin-box" data-id="123">
            ...
            <#if login_user?? && login_user.id=2>
              <#if q.recomm ==1>
                <span class="layui-btn layui-btn-xs question-admin" type="set" field="stick" rank="0" style="background-color:#ccc;">取消推荐</span>
                <#else >
                <span class="layui-btn layui-btn-xs jie-admin" type="set" field="stick" rank="1">推荐</span>
              </#if>
            </#if>
        ...
        <div class="detail-about">
          <a class="fly-avatar" href="/u/${u.id}">
            <img src="${u.headimg}" alt="${u.nickname!u.username!u.name}">
          </a>
